...
<div class="container mx-auto mt-8">
            ...
            <table class="min-w-full table-auto border-collapse border border-gray-300">
                <thead>
                    <tr class="bg-gray-200">
                        <th class="py-3 px-2 sm:px-4 border border-gray-300 text-left text-xs sm:text-sm">Order #</th>
                        <th class="py-3 px-2 sm:px-4 border border-gray-300 text-left text-xs sm:text-sm">Username</th>
                        <th class="py-3 px-2 sm:px-4 border border-gray-300 text-left text-xs sm:text-sm">Product</th>
                        <th class="py-3 px-2 sm:px-4 border border-gray-300 text-center text-xs sm:text-sm">Action</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach($orders as $order)
                        <tr class="hover:bg-gray-100">
                            <td class="py-3 px-2 sm:px-4 border border-gray-300 text-sm sm:text-base">{{ $order->id }}</td>
                            <td class="py-3 px-2 sm:px-4 border border-gray-300 text-sm sm:text-base">{{ $order->username }}</td>
                            <td class="py-3 px-2 sm:px-4 border border-gray-300 text-sm sm:text-base">{{ $order->product_Name }}</td>
                            <td class="py-3 px-2 sm:px-4 border border-gray-300 text-center">
                                <button
                                    class="bg-blue-500 text-white px-2 sm:px-4 py-1 sm:py-2 rounded hover:bg-blue-600"
    ...
    <div id="orderModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden">
        <div class="bg-white w-11/12 sm:w-1/2 rounded-lg shadow-lg p-4 sm:p-6">
