...
<section>
    ...
    <div class="w-[900px] h-[475px] bg-[#9EB7E5] bg-gradient-to-r from-[#9EB7E5] to-[#8DACE7] border rounded-[15px] flex items-center shadow-lg">
        ...
        <div class="bg-[#c9d6ff] w-1/2 m-4 h-[400px] border rounded-[14px] shadow-lg ">
            ...
            <form action="{{ route('login') }}" method="POST" class="flex flex-col gap-4 mr-7 ml-7">
                @csrf
                <input value="{{ old('username') }}"  class="p-1 mt-2 rounded-lg border" type="text" name="username"  placeholder="Username">
                <div class="relative">
                ...
                <button class="bg-[#002D74] text-white rounded-xl py-1">
            ...
            <p class="text-sm ml-5 border-b py-4 text-gray-700 mr-5 border-gray-700 flex items-center justify-center">
            ...
            <div class="flex items-center justify-center">
                <button class="px-5 py-1 bg-white flex justify-center border rounded-lg text-sm mt-2">
